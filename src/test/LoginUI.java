...
public class LoginUI extends JFrame
{
    ...
    public LoginUI(String title, int Weight, int Height) throws IOException
    {
        ...
        userLabel.setBounds(65, 125, 80, 30);
        panel.add(userLabel);
        this.usernameField = new JTextField(20);
        this.usernameField.setBounds(145, 125, 165, 30);
        panel.add(this.usernameField);

        JLabel passwordLabel = new JLabel("密码:");
        passwordLabel.setBounds(65, 165, 80, 30);
        panel.add(passwordLabel);
        this.passwordField = new JPasswordField(20);
        this.passwordField.setBounds(145, 165, 165, 30);
        ...
        JButton LoginButton = new JButton("登录");
        LoginButton.setBounds(230, 215, 100, 30);
        ...
        JButton RegisterButton = new JButton("注册");
        RegisterButton.setBounds(115, 215, 100, 30);
        this.add(RegisterButton);

        //插入背景图片

        ImageIcon backgroundImage = new ImageIcon("images/background2.png");
